...
<script>
  var userLoggedIn = '<?php echo $userLoggedIn; ?>'; //LECTURE 55
  ...
  $(document).ready(function() {
    ...
    $.ajax({
      ...
      type:"POST",
      data:"page=1&userLoggedIn=" + userLoggedIn + "&profileUsername=" + profileUsername, //userLoggedIn...SEE ajax_load_posts.php file
      cache:false,
  ...
  $(window).scroll(function() {
    ...
    var scroll_top = $(this).scrollTop(); //Top of page when you're scrolling
